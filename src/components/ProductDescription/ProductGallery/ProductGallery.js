  ...
  const galleryTransparentImages = props.galleryTransparent
    ...
    return (
      <div className="ProductGallery">
        {loader ? '' : <ImageGallery startIndex={productState.color} items={selectImages()} /> }
       ...
       { props.mockupPsd ? <button className="ProductGallery__button ProductGallery__button-1">
        <a
            href={props.mockupPsd ? props.mockupPsd[0].file.url : ""}
            download
            target="_blank"
            rel="noopener noreferrer"
          >
       ...
       {props.mockupJpg ? <button className="ProductGallery__button ProductGallery__button-1">
        <a
            href={props.mockupJpg ? props.mockupJpg[0].file.url : ""}
            download
            target="_blank"
            rel="noopener noreferrer"
          >
