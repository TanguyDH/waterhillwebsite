        ...
        <div className='ProductInfo' >
            <div className='ProductInfo__item'>
                ...
                <div className='ProductInfo__text ProductInfo__text--1'>
                   <Fade right> <h3>Une eau légèrement minéralisée</h3>
                    <span></span>
            ...
            <div className='ProductInfo__item'>
                ...
                <div className='ProductInfo__text ProductInfo__text--2'>
                    <Fade left><h3>Une eau au goût unique</h3>
                    <span></span>
            ...
            <div className='ProductInfo__item'>
                ...
                <div className='ProductInfo__text ProductInfo__text--1'>
                    <Fade right> <h3>Un long voyage sous terre avant d’être embouteillée</h3>
                    <span></span>
