    ...
    <div className="ContactCircle">
      <Fade bottom>
        <a
          ...
          className="ContactCircle__secondary ContactCircle__secondary--1"
        >
          <span>
            {" "}
            <FaFacebookMessenger />
        ...
        <a
          ...
          rel="noopener noreferrer"
          style={{ display: toggle ? "block" : "none" }}
          className="ContactCircle__secondary ContactCircle__secondary--2"
        >
          <span>
            {" "}
            <FaWhatsapp />
        ...
        <a
          href="mailto:contact@waterhill.be"
          style={{ display: toggle ? "block" : "none" }}
          className="ContactCircle__secondary ContactCircle__secondary--3"
        >
          <span>
            {" "}
            <FaEnvelope />
        ...
        <div
          className="ContactCircle__button"
